...
const HISTORY = [
  ...
  {
    year: '1989',
    event: '吉本初！売れてないのに東京進出。これを機に東京で新人発掘プロジェクトが始まる',
  },
  ...
  { year: '1998', event: '自信をつけるため1ヵ月連続毎日フルマラソン（42.195キロ）に挑戦、完走' },
  {
    year: '1998',
    event:
      '映画の資金を集めるために路上に座りインスピレーションで言葉を書く路上詩人となり大ブレーク！路上詩人という職業を作る',
  },
  {
    year: '2001',
    event: '一年で6,000万円を集める自転車日本一周の旅に挑戦、2002年に11ヶ月で6,000万円集める',
  },
  ...
  {
    year: '2007',
    event: '環境の意識を高める環境新聞「30秒で世界を変えちゃう豪快な号外」を3000万部発行',
  },
  { year: '2009', event: '映画「107＋1～天国はつくるもの～パート2」完成、上映開始' },
  { year: '2010', event: '日本の山のきらめき間伐活動開始' },
  {
    year: '2011',
    event: '東日本大震災後、緊急支援チーム「め組JAPAN」を結成し、被災地で支援活動を行う',
  },
  ...
  { year: '2014', event: '鼻唄を歌いながら夢の花を咲かせるセミナー「HANAHANA LAND」開講' },
  {
    year: '2015',
    event:
      '人間の可能性は無限であることを伝えるために46歳からゴルフを始め、プロゴルファーになることを宣言！',
  },
  ...
  {
    year: '2021',
    event: '沖縄県南城市にて、農薬かけず声をかけてマンゴーを創るヨミガエラセ屋始動！',
  },
  { year: '2022', event: '子どもママも妊娠中も通える「おなかの中から保育園」を開園' },
  {
    year: '2024',
    event: '子どもも大人も自分の ”好き” ”やりたい” に寄り添う小中高大一環校「ミライワライ」を開校',
  },
  {
    year: '2024',
    event: '「令和6年能登半島地震」支援チーム 復興支援団体 「TEAM JAPAN」を立ち上げる',
  },
];
      ...
      <section className="py-24 container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="leading-loose opacity-90">
            吉本興業奇跡の円満退社後、路上詩人、映画「天国はつくるもの」総指揮監督、NPO法人MAKE THE
            HEAVEN理事長、高校野球、女子ゴルファーのメンタルコーチとなるが、突然、プロゴルファーになると言い出し海外に武者修行。フィジーで天国の創り方を学ぶ。
            <br />
            <br />
            帰国後、不登校の子どもたちと沖縄から北海道を歩くツアーを開催。現在、沖縄で農薬かけずに声かけて作るマンゴー農家、妊娠中から通える保育園の理事長、個性と感性を伸ばすニュースクール【ミライワライ】の絶校長！
            <br />
            <br />
            沖縄南城市に世界中が友達になれる天国のようなビレッジを運営中！また全国やオンライン上で希望しかない爆笑講演、人生が劇的に変わる問いかけワークショップ、いろんな存在と繋がりメッセージがもらえる自動書記ワークショップも開催している！
            <br />
            <br />
