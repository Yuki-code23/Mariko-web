...
export const MOCK_NEWS: News[] = [
  ...
  },
  {
    ...
    category: 'イベント案内',
    content: '全国各地を回るツアーのスケジュールが公開されました。お近くの会場にぜひお越しください。',
...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    imageUrl: 'https://tentsukuman.onaka-hoiku.net/wp-content/uploads/2026/03/650656147_18537601456069805_2626661418232450334_n-300x300.jpg',
  ...
  },
  {
    ...
    location: '沖縄県〇〇市',
    description: '多世代交流拠点となる村のDIYワークショップ。一緒にペンキ塗りや畑作りを体験できます。',
    imageUrl: 'https://tentsukuman.onaka-hoiku.net/wp-content/uploads/2025/09/service_coool_village.jpg',
