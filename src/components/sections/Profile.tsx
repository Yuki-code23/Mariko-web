...
function TextSection() {
  return (
    ...
    >
      ...
      <h3 className="text-3xl md:text-5xl font-heading font-bold text-foreground">きっかけ番長<br />てんつくマンとは？</h3>
      <p className="text-foreground/80 leading-relaxed text-lg">
        元祖路上詩人としてこれまでに約15万人以上の方たちにインスピレーションで言葉を届けてきた。お笑い芸人から転身し、『動けば変わる』を合い言葉に「行動することの大切さ」を伝える講演や、社会活動家として幅広い分野で活動。
      </p>
      <Link href="/profile" className="inline-flex items-center gap-2 mt-4 text-brand-orange-dark font-bold hover:gap-4 transition-all">
